		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comiherbtmztmiherbpurchaseorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comiherbtmztmiherbpurchaseorders-display": {
								"semanticObject": "comiherbtmztmiherbpurchaseorders",
								"action": "display",
								"description": "Vendor Portal - Purchase Orders",
								"title": "Purchase Orders",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.iherb.tm.ztmiherbpurchaseorders",
									"url": sap.ui.require.toUrl("com/iherb/tm/ztmiherbpurchaseorders")
								}
							}
						}
					}
